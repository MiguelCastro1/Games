...
function Cell(i, j) {
  ...
  getOptions(){
    var options = [];
    if (!this.walls[0]) options.push(grid[index(this.i, this.j - 1)]);
    if (!this.walls[1]) options.push(grid[index(this.i + 1, this.j)]);
    if (!this.walls[2]) options.push(grid[index(this.i, this.j + 1)]);
    if (!this.walls[3]) options.push(grid[index(this.i - 1, this.j)]);
    return options;
  }
